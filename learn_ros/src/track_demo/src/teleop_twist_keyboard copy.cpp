...
int main(int argc, char** argv)
{
    ...
    ros::Publisher pub = nh.advertise<geometry_msgs::Twist>("/cmd_vel", 1); //org
    // ros::Publisher pub = nh.advertise<geometry_msgs::Twist>("/mavros/setpoint_velocity/cmd_vel_unstamped", 1);
